...
CREATE TABLE IF NOT EXISTS phone_book.User (id BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT, fullname varchar(45), login varchar(45), password varchar(100), INDEX(login));
